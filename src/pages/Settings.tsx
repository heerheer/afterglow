...
const Settings: React.FC<SettingsProps> = ({ habits, onRefresh }) => {
  ...
  useEffect(() => {
    ...
    const checkVersion = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/heerheer/afterglow/tags');
          ...
          <div className="border-t border-border pt-2  md:pt-6 space-y-3">
            <div className="flex justify-between items-center text-sm">
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                {latestVersion && latestVersion !== import.meta.env.VITE_APP_VERSION && (
                  <a
                    href="https://github.com/heerheer/afterglow/releases"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[10px] text-primary hover:underline font-medium animate-pulse"
                  >
